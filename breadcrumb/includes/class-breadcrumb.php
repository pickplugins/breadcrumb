		...
		public function breadcrumb_html($themes){
			...
			$active_plugins = get_option('active_plugins');
				...
				elseif(is_404()){
						...
						$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span class="separator">'.$breadcrumb_separator.'</span><a itemprop="item" href="'.$breadcrumb_url_hash.'">'.__('404', breadcrumb_textdomain).'</a></li>';
